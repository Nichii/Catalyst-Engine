...
extern "C"
{
    ...
    // [DEPRECATED] Gets the frame pipeline token for the frame that was most recently displayed on the streaming
    // client's screen.
    // This API is deprecated and will be removed in a future GDK release.
    EXTERN_C __declspec(deprecated("XGameStreamingGetLastFrameDisplayed is deprecated and will be removed in a future GDK release."))
    HRESULT STDAPICALLTYPE XGameStreamingGetLastFrameDisplayed(
           _In_ XGameStreamingClientId client,
    ...
    // [DEPRECATED] Gets the frame pipeline token from a specific input reading.
    // This API is deprecated and will be removed in a future GDK release.
    EXTERN_C __declspec(deprecated("XGameStreamingGetAssociatedFrame is deprecated and will be removed in a future GDK release."))
    HRESULT STDAPICALLTYPE XGameStreamingGetAssociatedFrame(
    ...
    // [DEPRECATED] Gets the specified client's IP address that the server is communicating with.
    // This API is deprecated and will be removed in a future GDK release.
    // On the converged (WebRTC) streaming stack, this API returns E_GAMESTREAMING_NO_DATA.
    EXTERN_C __declspec(deprecated("XGameStreamingGetClientIPAddress is deprecated and will be removed in a future GDK release."))
    HRESULT STDAPICALLTYPE XGameStreamingGetClientIPAddress(
        _In_ XGameStreamingClientId client,
