...
/// To use this feature, you must define PFMULTIPLAYER_INCLUDE_SERVER_APIS before including PFMatchmaking.h.
/// <para>
/// The library automatically, and asynchronously, submits a server backfill ticket to the matchmaking service. Each
/// time the ticket status changes, a <see cref="PFMatchmakingTicketStatusChangedStateChange" /> is provided. The
...
/// </para>
/// <para>
/// When the ticket completed, a <see cref="PFMatchmakingTicketStatusChangedStateChange" /> is provided. At
/// that point, a match for the backfill ticket is found or the ticket stopped due to failure. On success,
/// the match that was found can be queried via <see cref="PFMatchmakingTicketGetMatch()" />. The
/// <c>regionPreferences</c> in <see cref="PFMatchmakingMatchDetails" /> only contains the region that the server is
/// located in.
/// </para>
/// <para>
