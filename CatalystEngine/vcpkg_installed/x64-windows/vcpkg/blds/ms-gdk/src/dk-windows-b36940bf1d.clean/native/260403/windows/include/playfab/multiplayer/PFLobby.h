...
struct PFLobbyCreateConfiguration
{
    ...
    /// </summary>
    /// <remarks>
    /// When true, only the lobby owner can send invites. When false, any member can send invites. Can only be true for
...
struct PFLobbyDataUpdate
{
    ...
    /// client-owned lobbies.
    /// </remarks>
    _Maybenull_ const bool * restrictInvitesToLobbyOwner;
};
...
/// If this lobby object was created by calling <see cref="PFMultiplayerJoinLobby()" />, this method will return an
/// error until <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" /> provides a
/// <see cref="PFLobbyUpdatedStateChange" /> with
/// <see cref="PFLobbyUpdatedStateChange::restrictInvitesToLobbyOwnerUpdated" /> set to true. If joining the lobby
/// succeeds, this field is guaranteed to be populated by the time PFMultiplayerStartProcessingLobbyStateChanges()
/// provides a <see cref="PFLobbyJoinLobbyCompletedStateChange" />.
/// </para>
/// <para>
/// If this lobby object was created by calling <see cref="PFMultiplayerClaimServerLobby()" />, this method will return
/// an error until <see cref="PFMultiplayerStartProcessingLobbyStateChanges()" /> provides a
/// <see cref="PFLobbyUpdatedStateChange" /> with
/// <see cref="PFLobbyUpdatedStateChange::restrictInvitesToLobbyOwnerUpdated" /> set to true. If claiming the lobby
/// succeeds, this field is guaranteed to be populated by the time PFMultiplayerStartProcessingLobbyStateChanges()
/// provides a <see cref="PFLobbyClaimServerLobbyCompletedStateChange" />.
/// </para>
/// </remarks>
/// <param name="lobby">
/// The handle of the lobby.
/// </param>
/// <param name="restrictInvitesToLobbyOwner">
...
PFLobbyGetRestrictInvitesToLobbyOwner(
    PFLobbyHandle lobby,
    _Out_ bool * restrictInvitesToLobbyOwner
    ) noexcept;
...
/// </param>
/// <param name="newMember">
/// A PFEntityHandle for the local PlayFab entity connecting to the lobby. The PFEntityHandle is obtained from a PlayFab Core
/// authentication API.
/// </param>
/// <param name="lobbyId">
/// The ID of the Lobby to connect.
...
HRESULT
PFMULTIPLAYER_API
PFMultiplayerConnectToLobbyWithEntityHandle(
    PFMultiplayerHandle handle,
    PFEntityHandle newMember,
    _Null_terminated_ const char * lobbyId,
    _In_opt_ void * asyncContext,
