...
// 0x8924010D
//
// MessageId: E_GAMERUNTIME_SERVICE_NOT_AVAILABLE
//
// MessageText:
//
// This service is not available on the current platform.
//
#define E_GAMERUNTIME_SERVICE_NOT_AVAILABLE ((HRESULT)0x8924010DL)
...
// 0x89245212
//
// MessageId: E_GAMEPACKAGE_CONFIG_x64_EXECUTABLE_REQUIRED
//
// MessageText:
//
// Could not find an 'Executable' child with an 'Architecture' attribute set to 'x64'.
// Please ensure at least one of the 'Executables' from 'ExecutableList' has an 'Architecture' set to 'x64'.
//
#define E_GAMEPACKAGE_CONFIG_x64_EXECUTABLE_REQUIRED ((HRESULT)0x89245212L)
